using AccountService.Data.Dtos;
...
namespace AccountService.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            await playerRepository.Update(new Data.Entities.Player 
            { FirstName = dto.FirstName, LastName = dto.LastName, UserName = dto.UserName, Id= dto.Id });
